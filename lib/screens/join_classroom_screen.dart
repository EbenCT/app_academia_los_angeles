...
// También vamos a modificar el método _toggleQRScanner
    ...
    children: [
             ClipRRect(
              ...
              child: _scannerController != null
                  ?// En el callback onDetect del MobileScanner:
MobileScanner(
  ...
  Widget _buildSpaceBackground(Size screenSize) {
    return Container(
      ...
      child: Stack(
        children: [
          // Estrellas parpadeantes (reutilizamos del LoginScreen)
          ..._generateStars(200, screenSize),
          // Planeta decorativo
          Positioned(
  ...
  // Función para generar estrellas aleatorias (reutilizada del LoginScreen)
  ...
  // Construye una estrella con animación de brillo (reutilizada del LoginScreen)
